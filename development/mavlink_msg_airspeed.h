...
{
    return mavlink_msg_airspeed_pack_status(system_id, component_id, _status, msg,  airspeed->id, airspeed->airspeed, airspeed->temperature, airspeed->press_diff, airspeed->press_static, airspeed->error, airspeed->type);
}
